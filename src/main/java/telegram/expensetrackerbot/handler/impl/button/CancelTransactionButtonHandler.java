...
import static telegram.expensetrackerbot.util.Constants.BUTTON_CANCEL;
...
@Component
public class CancelTransactionButtonHandler extends CancelTransactionHandler {
    protected CancelTransactionButtonHandler(KeyboardBuilder keyboardBuilder,
