...
@Component
public class ShowExpensesCommandHandler implements UserRequestHandler {
    private final KeyboardBuilder keyboardBuilder;
    private final MessageSender messageSender;
    private final UserSessionService userSessionService;

    public ShowExpensesCommandHandler(KeyboardBuilder keyboardBuilder, MessageSender messageSender,
    ...
    public boolean isApplicable(UserRequest userRequest) {
        return isCommand(userRequest.getUpdate(), COMMAND_SHOW_EXPENSES);
    }
    ...
    public void handle(UserRequest userRequest) {
        ...
        userSession.setCommandState(CommandState.SHOW_EXPENSES);
